...
class NExpression : public Node {
 public:
  ...
  string getTypeName() const override { return "NExpression"; }
...
class NStatement : public Node {
 public:
  ...
  string getTypeName() const override { return "NStatement"; }
  virtual void print(string prefix) const override {
    cout << prefix << getTypeName() << endl;
  }
...
class NDouble : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NDouble"; }
...
class NInteger : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NInteger"; }
  ...
  operator NDouble() { return NDouble(value); }
...
class NIdentifier : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NIdentifier"; }
...
class NMethodCall : public NExpression {
 public:
  ...
  NMethodCall(const shared_ptr<NIdentifier> id) : id(id) {}

  string getTypeName() const override { return "NMethodCall"; }
...
class NBinaryOperator : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NBinaryOperator"; }
...
class NAssignment : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NAssignment"; }
...
class NBlock : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NBlock"; }
...
class NExpressionStatement : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NExpressionStatement"; }
...
class NVariableDeclaration : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NVariableDeclaration"; }
...
class NFunctionDeclaration : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NFunctionDeclaration"; }
  ...
  void print(string prefix) const override {
    ...
    if (block) block->print(nextPrefix);
  }
...
class NStructDeclaration : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NStructDeclaration"; }
...
class NReturnStatement : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NReturnStatement"; }
...
class NIfStatement : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NIfStatement"; }
...
class NForStatement : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NForStatement"; }

  void print(string prefix) const override {
    string nextPrefix = prefix + this->m_PREFIX;
    cout << prefix << getTypeName() << this->m_DELIM << endl;

    if (initial) initial->print(nextPrefix);
    if (condition) condition->print(nextPrefix);
    if (increment) increment->print(nextPrefix);
  ...
  Json::Value jsonGen() const override {
    ...
    if (initial) root["children"].append(initial->jsonGen());
    if (condition) root["children"].append(condition->jsonGen());
    if (increment) root["children"].append(increment->jsonGen());
...
class NStructMember : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NStructMember"; }
...
class NArrayIndex : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NArrayIndex"; }
...
class NArrayAssignment : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NArrayAssignment"; }
...
class NArrayInitialization : public NStatement {
 public:
  ...
  string getTypeName() const override { return "NArrayInitialization"; }
...
class NStructAssignment : public NExpression {
 public:
  ...
  string getTypeName() const override { return "NStructAssignment"; }
...
class NLiteral : public NExpression {
 public:
  ...
  NLiteral(const string& str) { value = str.substr(1, str.length() - 2); }

  string getTypeName() const override { return "NLiteral"; }
